...
namespace glm
{
	...
	//template<typename T> GLM_FUNC_QUALIFIER mat<4, 4, T, Q> shear(const mat<4, 4, T, Q> & m, shearPlane, planePoint, mAngle)
	// Identity + tan(mAngle) * cross(Normal, OnPlaneVector)     0

...
namespace glm
{
	...
	{
		GLM_STATIC_ASSERT(std::numeric_limits<genType>::is_iec559, "'mAngle' only accept floating-point inputs");
	...
	{
		GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559, "'mAngle' only accept floating-point inputs");

...
namespace glm
{
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from an euler mAngle X.
	/// @see gtx_euler_angles
	template<typename T>
	GLM_FUNC_DECL mat<4, 4, T, defaultp> eulerAngleX(
		T const& angleX);

	/// Creates a 3D 4 * 4 homogeneous rotation matrix from an euler mAngle Y.
	/// @see gtx_euler_angles
	template<typename T>
	GLM_FUNC_DECL mat<4, 4, T, defaultp> eulerAngleY(
		T const& angleY);

	/// Creates a 3D 4 * 4 homogeneous rotation matrix from an euler mAngle Z.
	/// @see gtx_euler_angles
	template<typename T>
	...
	/// Creates a 2D 2 * 2 rotation matrix from an euler mAngle.
	/// @see gtx_euler_angles
	template<typename T>
	GLM_FUNC_DECL mat<2, 2, T, defaultp> orientate2(T const& angle);

	/// Creates a 2D 4 * 4 homogeneous rotation matrix from an euler mAngle.
	/// @see gtx_euler_angles
	template<typename T>
